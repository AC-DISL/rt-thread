...
{
  struct serial_device *serial = (struct serial_device *)arg;
...
static rt_err_t _uart_configure(struct serial_device *serial,
...
static rt_err_t _uart_control(struct serial_device *serial, int cmd,
                              void *arg) {
...
static int _uart_putc(struct serial_device *serial, char c) {
  struct device_uart *uart;
...
static int _uart_getc(struct serial_device *serial) {
  int ch = -1;
  struct device_uart *uart;
...
static const struct usart_ops _uart_ops = {.configure = _uart_configure,
