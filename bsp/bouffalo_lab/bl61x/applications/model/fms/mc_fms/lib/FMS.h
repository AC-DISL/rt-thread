...
typedef struct {
  ...
  uint8_T temporalCounter_i1;          /* '<S50>/Motion Status' */
...
typedef struct {
  ...
  uint32_T durationCounter_1;          /* '<Root>/FMS State Machine' */
  uint32_T durationCounter_1_b;        /* '<Root>/FMS State Machine' */
  uint32_T durationCounter_1_i;        /* '<Root>/FMS State Machine' */
  uint32_T durationCounter_2;          /* '<Root>/FMS State Machine' */
  uint32_T durationCounter_1_iv;       /* '<Root>/FMS State Machine' */
  uint32_T durationCounter_1_p;        /* '<Root>/FMS State Machine' */
  uint32_T durationCounter_2_p;        /* '<Root>/FMS State Machine' */
  ...
  uint16_T temporalCounter_i1_h;       /* '<S112>/Motion State' */
  ...
  int8_T SwitchCase_ActiveSubsystem_p; /* '<S349>/Switch Case' */
  int8_T SwitchCase_ActiveSubsystem_bn;/* '<S359>/Switch Case' */
  int8_T SwitchCase_ActiveSubsystem_pv;/* '<S371>/Switch Case' */
  ...
  uint8_T temporalCounter_i1_j;        /* '<S360>/Motion State' */
  uint8_T Integrator1_IC_LOADING_j;    /* '<S399>/Integrator1' */
  boolean_T valid_cmd;                 /* '<Root>/FMS State Machine' */
  boolean_T bl;                        /* '<Root>/FMS State Machine' */
  boolean_T br;                        /* '<Root>/FMS State Machine' */
  boolean_T M_isValid;                 /* '<Root>/FMS State Machine' */
  boolean_T icLoad;                    /* '<S184>/Delay' */
  boolean_T icLoad_k;                  /* '<S162>/Delay' */
  boolean_T icLoad_l;                  /* '<S418>/Delay' */
  boolean_T icLoad_j;                  /* '<S396>/Delay' */
  boolean_T icLoad_c;                  /* '<S395>/Delay' */
  boolean_T icLoad_j1;                 /* '<S479>/cur_waypoint' */
...
typedef struct {
  ...
  const real32_T VectorConcatenate3_e[3];/* '<S247>/Vector Concatenate3' */
  const real32_T VectorConcatenate3_o[3];/* '<S249>/Vector Concatenate3' */
  const real32_T VectorConcatenate3_n[3];/* '<S309>/Vector Concatenate3' */
  const real32_T VectorConcatenate3_i[3];/* '<S313>/Vector Concatenate3' */
  const real32_T VectorConcatenate3_ny[3];/* '<S316>/Vector Concatenate3' */
  const real32_T VectorConcatenate3_e0[3];/* '<S317>/Vector Concatenate3' */
  ...
  ConstB_VehicleArmAutoMissionL_T VehicleArmAutoMissionLLA2FLAT;
                                  /* '<S5>/Vehicle.Arm.Auto.Mission.LLA2FLAT' */
