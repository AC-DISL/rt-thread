...
void Plant_step(void)
{
   ...
   */
  rtb_Gain3 = csi_cos_f32(-Plant_Y.Plant_States.psi);
   ...
   */
  rtb_Square_idx_2 = csi_sin_f32(-Plant_Y.Plant_States.psi);
  ...
  rtb_Add_ow = csi_cos_f32(rtb_Square_b[0]);

  /* Trigonometry: '<S90>/Cos1' */
  rtb_MathFunction1_k = csi_cos_f32(rtb_Square_b[1]);

  /* Trigonometry: '<S90>/Cos2' */
  rtb_Sum1_dw_idx_0 = csi_cos_f32(rtb_Square_b[2]);

  /* Trigonometry: '<S90>/Sin' */
  rtb_Product8 = csi_sin_f32(rtb_Square_b[0]);

  /* Trigonometry: '<S90>/Sin1' */
  rtb_Square2_b = csi_sin_f32(rtb_Square_b[1]);

  /* Trigonometry: '<S90>/Sin2' */
  rtb_Gain_kz = csi_sin_f32(rtb_Square_b[2]);
   ...
   */
  rtb_SumofElements1 = csi_sin_f32(Plant_DW.DiscreteTimeIntegrator_DSTATE[0]) *
    rtb_TrigonometricFunction2;
   ...
   */
  rtb_Cm = csi_cos_f32(Plant_DW.DiscreteTimeIntegrator_DSTATE[0]) *
    rtb_TrigonometricFunction2;
   ...
   *  Trigonometry: '<S163>/Trigonometric Function2'
   */
  rtb_SumofElements = csi_sin_f32(Plant_DW.DiscreteTimeIntegrator_DSTATE[1]) *
    rtb_TrigonometricFunction2;
   ...
   *  Trigonometry: '<S163>/Trigonometric Function1'
   */
  rtb_Cl_zA = csi_cos_f32(Plant_DW.DiscreteTimeIntegrator_DSTATE[1]) *
    rtb_TrigonometricFunction2;
   ...
   *  Trigonometry: '<S163>/Trigonometric Function2'
   */
  rtb_SumofElements1 = ((rtb_SumofElements1 + rtb_SumofElements) + csi_sin_f32
                        (Plant_DW.DiscreteTimeIntegrator_DSTATE[2]) *
                        rtb_TrigonometricFunction2) + csi_sin_f32
   ...
   *  Trigonometry: '<S163>/Trigonometric Function1'
   */
  rtb_SumofElements = ((rtb_Cm + rtb_Cl_zA) + csi_cos_f32
                       (Plant_DW.DiscreteTimeIntegrator_DSTATE[2]) *
                       rtb_TrigonometricFunction2) + csi_cos_f32
    (Plant_DW.DiscreteTimeIntegrator_DSTATE[3]) * rtb_Cl_xA;
   ...
   */
  rtb_SumofElements1 = csi_sin_f32(Plant_DW.DiscreteTimeIntegrator_DSTATE_f[0]) *
    rtb_TrigonometricFunction2;
   ...
   */
  rtb_Cm = csi_cos_f32(Plant_DW.DiscreteTimeIntegrator_DSTATE_f[0]) *
    rtb_TrigonometricFunction2;
   ...
   *  Trigonometry: '<S152>/Trigonometric Function2'
   */
  rtb_SumofElements = csi_sin_f32(Plant_DW.DiscreteTimeIntegrator_DSTATE_f[1]) *
    rtb_TrigonometricFunction2;
   ...
   *  Trigonometry: '<S152>/Trigonometric Function1'
   */
  rtb_Cl_zA = csi_cos_f32(Plant_DW.DiscreteTimeIntegrator_DSTATE_f[1]) *
    rtb_TrigonometricFunction2;
   ...
   *  Trigonometry: '<S152>/Trigonometric Function2'
   */
  rtb_SumofElements = ((rtb_SumofElements1 + rtb_SumofElements) + csi_sin_f32
   ...
   *  Trigonometry: '<S152>/Trigonometric Function1'
   */
  rtb_SumofElements1 = ((rtb_Cm + rtb_Cl_zA) + csi_cos_f32
                        (Plant_DW.DiscreteTimeIntegrator_DSTATE_f[2]) *
                        rtb_TrigonometricFunction2) + csi_cos_f32
    (Plant_DW.DiscreteTimeIntegrator_DSTATE_f[3]) * rtb_Cl_xA;
   ...
   */
  rtb_magnitude_gauss = csi_cos_f32(rtb_Sum1_dw_idx_0);
   ...
   */
  rtb_Add_ow = csi_sin_f32(rtb_Sum1_dw_idx_0);
