...
void Plant_step(void)
{
   ...
   */
  rtb_Multiply4_i_idx_0 = csi_cos_f32(-Plant_Y.Plant_States.psi);
   ...
   */
  rtb_Multiply4_i_idx_1 = csi_sin_f32(-Plant_Y.Plant_States.psi);
  ...
  rtb_Add_e = csi_cos_f32(rtb_Multiply2_p[0]);

  /* Trigonometry: '<S69>/Cos1' */
  rtb_MathFunction1_c = csi_cos_f32(rtb_Multiply2_p[1]);

  /* Trigonometry: '<S69>/Cos2' */
  rtb_Divide_f_idx_2 = csi_cos_f32(rtb_Multiply2_p[2]);

  /* Trigonometry: '<S69>/Sin' */
  rtb_Product8 = csi_sin_f32(rtb_Multiply2_p[0]);

  /* Trigonometry: '<S69>/Sin1' */
  rtb_Divide_f_idx_1 = csi_sin_f32(rtb_Multiply2_p[1]);

  /* Trigonometry: '<S69>/Sin2' */
  rtb_Gain_h = csi_sin_f32(rtb_Multiply2_p[2]);
   ...
   */
  rtb_SumofElements = csi_sin_f32(Plant_DW.DiscreteTimeIntegrator_DSTATE[0]) *
    rtb_Product1;
   ...
   */
  rtb_Product1_idx_0 = csi_cos_f32(Plant_DW.DiscreteTimeIntegrator_DSTATE[0]) *
    rtb_Product1;
   ...
   *  Trigonometry: '<S139>/Trigonometric Function2'
   */
  rtb_Product2_g_idx_1 = csi_sin_f32(Plant_DW.DiscreteTimeIntegrator_DSTATE[1]) *
    rtb_Product1;
   ...
   *  Trigonometry: '<S139>/Trigonometric Function1'
   */
  rtb_Product1_idx_1 = csi_cos_f32(Plant_DW.DiscreteTimeIntegrator_DSTATE[1]) *
    rtb_Product1;
   ...
   *  Trigonometry: '<S139>/Trigonometric Function2'
   */
  rtb_SumofElements = ((rtb_SumofElements + rtb_Product2_g_idx_1) + csi_sin_f32
                       (Plant_DW.DiscreteTimeIntegrator_DSTATE[2]) *
                       rtb_Product1) + csi_sin_f32
   ...
   *  Trigonometry: '<S139>/Trigonometric Function1'
   */
  rtb_Product1 = ((rtb_Product1_idx_0 + rtb_Product1_idx_1) + csi_cos_f32
                  (Plant_DW.DiscreteTimeIntegrator_DSTATE[2]) * rtb_Product1) +
    csi_cos_f32(Plant_DW.DiscreteTimeIntegrator_DSTATE[3]) * rtb_SumofElements1;
   ...
   */
  rtb_SumofElements = csi_sin_f32(Plant_DW.DiscreteTimeIntegrator_DSTATE_p[0]) *
    rtb_Product1;
   ...
   */
  rtb_Product1_idx_0 = csi_cos_f32(Plant_DW.DiscreteTimeIntegrator_DSTATE_p[0]) *
    rtb_Product1;
   ...
   *  Trigonometry: '<S128>/Trigonometric Function2'
   */
  rtb_Product2_g_idx_1 = csi_sin_f32(Plant_DW.DiscreteTimeIntegrator_DSTATE_p[1])
    * rtb_Product1;
   ...
   *  Trigonometry: '<S128>/Trigonometric Function1'
   */
  rtb_Product1_idx_1 = csi_cos_f32(Plant_DW.DiscreteTimeIntegrator_DSTATE_p[1]) *
    rtb_Product1;
  ...
  rtb_Product1 = ((rtb_Product1_idx_0 + rtb_Product1_idx_1) + csi_cos_f32
    ...
    + csi_cos_f32(Plant_DW.DiscreteTimeIntegrator_DSTATE_p[3]) *
    rtb_SumofElements1;
   ...
   */
  rtb_Multiply4_i_idx_0 = csi_cos_f32(rtb_Divide_f_idx_2);
  rtb_VectorConcatenate_f[0] = rtb_Multiply4_i_idx_0;

  /* Trigonometry: '<S155>/Trigonometric Function' incorporates:
   *  Trigonometry: '<S155>/Trigonometric Function2'
   */
  rtb_Multiply4_i_idx_1 = csi_sin_f32(rtb_Divide_f_idx_2);
  rtb_VectorConcatenate_f[1] = rtb_Multiply4_i_idx_1;
   ...
   */
  rtb_DiscreteTimeIntegrator_l_id = csi_cos_f32(rtb_Divide_f_idx_2);
   ...
   */
  rtb_Divide_f_idx_1 = csi_sin_f32(rtb_Divide_f_idx_2);
